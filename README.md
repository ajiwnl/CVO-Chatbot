# CVO-Furbot: This is a Flask-based chatbot API that utilizes fuzzy matching (difflib) to find the closest responses from a predefined dataset of City Veterinary's FAQ.
